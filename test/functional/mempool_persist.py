#!/usr/bin/env python3
# Copyright (c) 2014-2017 The Vritzcoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test mempool persistence.

By default, vritzcoind will dump mempool on shutdown and
...
class MempoolPersistTest(VritzcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(1)
        self.start_node(2)
        # Give vritzcoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent vritzcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
