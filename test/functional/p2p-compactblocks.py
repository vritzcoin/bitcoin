...
# TestNode: A peer we use to send messages to vritzcoind, and store responses.
...
class CompactBlocksTest(VritzcoinTestFramework):
    ...
    # This test actually causes vritzcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that vritzcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for vritzcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # vritzcoind will not send blocktxn responses for blocks whose height is
