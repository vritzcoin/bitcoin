...
Vritzcoin Core version *version* is now available from:

  <https://vritzcoin.space/bin/vritzcoin-core-*version*/>
...
GCC 4.8.x
--------------
The minimum version of GCC required to compile Vritzcoin Core is now 4.8. No effort will be
