...
This document provides guidelines for internationalization of the Vritzcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `vritzcoin_en.ts` remains unchanged.
