Vritzcoin Core version 0.10.4 is now available from:

  <https://vritzcoin.space/bin/vritzcoin-core-0.10.4/>
...
- #6953 `43c2789` Split vritzcoin-tx into its own package
- #6953 `dfe0d4d` Include vritzcoin-tx binary on Debian/Ubuntu
