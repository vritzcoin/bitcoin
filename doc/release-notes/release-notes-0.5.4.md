Vritzcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/vritzcoin/files/Vritzcoin/vritzcoin-0.5.4/
...
http://gitorious.org/vritzcoin/vritzcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Vritzcoin-Qt notifications under Growl 1.3.
Increase required age of Vritzcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxVritzcoin properly when installing Vritzcoin-Qt over it. (Windows)
