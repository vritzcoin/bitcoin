Vritzcoin Core version 0.9.4 is now available from:

  https://vritzcoin.space/bin/0.9.4/
...
this update is incompatible with the Vritzcoin system and could lead to consensus
forks.

Vritzcoin Core released binaries from https://vritzcoin.space are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~vritzcoin/+archive/ubuntu/vritzcoin
- A third-party or self-compiled Vritzcoin Core

upgrade to Vritzcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
