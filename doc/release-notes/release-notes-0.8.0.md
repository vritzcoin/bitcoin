Vritzcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/vritzcoin/files/Vritzcoin/vritzcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Vritzcoin
...
New/changed settings (command-line or vritzcoin.conf file)
--------------------------------------------------------
