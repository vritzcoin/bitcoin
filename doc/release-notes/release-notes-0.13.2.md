Vritzcoin Core version 0.13.2 is now available from:

  <https://vritzcoin.space/bin/vritzcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update vritzcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow vritzcoin-tx to create v2 transactions (btcdrak)
