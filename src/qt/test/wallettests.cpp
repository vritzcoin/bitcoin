...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<VritzcoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_vritzcoin-qt -platform xcb      # Linux
//     src/qt/test/test_vritzcoin-qt -platform windows  # Windows
//     src/qt/test/test_vritzcoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = VritzcoinUnits::formatWithUnit(unit, balance, false, VritzcoinUnits::separatorAlways);
    ...
    // Amount input
    VritzcoinAmountField* amountInput = receiveCoinsDialog.findChild<VritzcoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: vritzcoin:")) != -1);
