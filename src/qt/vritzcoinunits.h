...
/** Vritzcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class VritzcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit VritzcoinUnits(QObject *parent);

    /** Vritzcoin units.
      @note Source: https://en.vritzcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef VritzcoinUnits::Unit VritzcoinUnit;
