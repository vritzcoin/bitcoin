 ...
 * between vritzcoind, and vritzcoin-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("vritzcoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/vritzcoin/vritzcoin>";
    const std::string URL_WEBSITE = "<https://vritzcoincore.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("vritzcoin-loadblk");
...
/** Sanity checks
 *  Ensure that Vritzcoin is running in a usable environment with all
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Vritzcoin process is using the data directory.
